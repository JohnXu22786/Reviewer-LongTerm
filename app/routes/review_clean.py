    ...
    try:
        ...
        if PLUGIN_AVAILABLE and call_plugin_func:
            ...
            if plugin_result and plugin_result.get("success"):
                return jsonify({
                    "success": True,
                    "next_item": plugin_result.get("next_item"),
                    "progress": plugin_result.get("progress"),
                    "remaining_items": plugin_result.get("progress", {}).get("remaining_items", 0),
                    "total_mastered": plugin_result.get("progress", {}).get("mastered_items", 0),
                    "total_items": plugin_result.get("progress", {}).get("total_items", 0)
                })

        # Plugin not available - return minimal response
        return jsonify({
            "success": False,
        ...
        if PLUGIN_AVAILABLE and call_plugin_func:
            ...
            if plugin_result and plugin_result.get("success"):
                ...
                return jsonify({
                    ...
                    "remaining_items": result.get("remaining_items", 0),
                    "total_mastered": result.get("total_mastered", 0),
                    "total_items": result.get("total_items", 0),
                    "sequence_updated": result.get("sequence_updated", False),
